...
There are NO "**FABRICATED_K0_QUOTE_50857**_NONEXISTENT_DOES_NOT_APPEAR_ANYWHERE_" ALL modes are origin-localized to some degree. The mass fraction m_in decreases smoothly from 0.967 to 0.535 as Re increases from −0.48 to 0.0. This is a continuous spectrum, not two discrete populations.
