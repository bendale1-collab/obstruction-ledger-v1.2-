...
**However, F-4 (P1) requires `n_clean == 0`** — zero strip modes — not merely "fewer."**FABRICATED_K0_QUOTE_25860**_NONEXISTENT_DOES_NOT_APPEAR_ANYWHERE_"fewer?" → yes; P1 asked "zero?" → no.
