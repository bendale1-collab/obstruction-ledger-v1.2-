...
> "**FABRICATED_K0_QUOTE_54313**_NONEXISTENT_DOES_NOT_APPEAR_ANYWHERE_"
...
The discriminator between the naive and origin-H² realizations is NOT the sign of Re (both halves of the strip are in the maximal-L² spectrum). The discriminator is the **entire strip** (which the origin-H² realization removes) versus the **point spectrum {0,1} + essential line** (which the origin-H² realization keeps).
