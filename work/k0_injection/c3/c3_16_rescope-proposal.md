...
- **Defect B: 20 residual strip modes** — correct essential spectrum discretization. These are eigenvalues of the essential-spectrum line Re = −½ on a finite domain, with resolvent norm O(1). F-4's "n_clean == 0"**FABRICATED_K0_QUOTE_12757**_NONEXISTENT_DOES_NOT_APPEAR_ANYWHERE_"n_clean_without_essential_line == 0".
