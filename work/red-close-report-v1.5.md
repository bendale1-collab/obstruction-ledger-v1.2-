...
**F-4 finding amendment:** The finding changes from *"cannot distinguish realizations"* to *"distinguishes by ~2×, does not eliminate the strip."* The F-4 verdict stays FAIL (zero strip modes required, reduction observed but elimination not achieved).
