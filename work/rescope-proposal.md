...
- **Defect B: 20 residual strip modes** — correct essential spectrum discretization. These are eigenvalues of the essential-spectrum line Re = −½ on a finite domain, with resolvent norm O(1). F-4's "n_clean == 0" criterion is wrong; the correct criterion is "n_clean_without_essential_line == 0".
